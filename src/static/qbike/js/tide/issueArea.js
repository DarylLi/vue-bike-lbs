        ...
        _api: function(_base_url) {
            ...
            return {
                debug: {
                    ...
                    list:_base_url +'/IA_list.json',
                    del:_base_url +'/IA_del.json',
                    save:_base_url +'/IA_save.json',
                    get:_base_url +'/IA_get.json',
                    listBikes:'/cityAreaLocks?sideLength=1500&geoCode=&city=wx',
                },
                product: {
                    add:'/illegal/add',
                    list:'/illegal/list',
...
var iArea = {
    ...
    //        // },
    //        success: function (data) {
    //            data.success && data.returnCode == 0 && data.data.data && iArea.parseNextPageData(data.data);
    //        }
    //    });
    //},
    ...
    parseData: function (data) {
        ...
        for (var i in data){
            ...
            data_append += "<tr><td><input type='checkbox' name='lockId' value='"+data[i].id+"'/></td><td>"+data[i].name+"</td><td><a href='javascript:void(0)' class='AreaOption' id='"+data[i].id+"'>设置</a></td><td>"+data[i].remark+"</td></tr>";
        }
        $("#Pagination tbody").append(data_append);
        $(".AreaOption").off().on("click",function(){
            $("#option_panel").show();
        ...
        //            status: iArea.status,
        //            pow: iArea.pow,
        //            producer: iArea.producer,
        //            channel: iArea.channel,
        //            pageSize: pageSize,
        //            currPage: num
        //        };
        //        iArea.initNextPageData(params);
        //    }
        //});
    },
    ...
    componentInit: function () {
            ...
            $.ajax({
                ...
                success: function (data) {
                    ...
                    for(var i in data.data){
                        totArea.push(data.data[i].region);
                    }
                    $("#bike_detail").show();
                    area_obj.init();
        ...
        $("#save_Tarea").off().on("click",function(){
            ...
            var area_msg=$("#area_msg").val();
            //if(area_name&&area_msg)
            if(area_name)
            $.ajax({
    ...
    drawPolygon:function(){
        ...
        for(var i in totArea){
            ...
            for(var j in AreaItem){
                ...
                if(j==0)this.map.setZoomAndCenter(10,polygon.getPath()[0]);
            }
        }
        //var polygonArr1=[[116.403322,39.920255],
...
var area_option={
    ...
    drawPolygon:function(){
        ...
        $.ajax({
            ...
            success: function (data) {
                var AreaItem=eval(data.data.region);
...
$("#save_judge").on('click',function(){
    var lockId = $('.lock-id').val();
    var url=iArea.status!=undefined?("lockId="+lockId+"&status="+iArea.status+"&pow="+iArea.pow+"&channel="+iArea.channel+"&producer="+iArea.producer):("lockId="+lockId);
