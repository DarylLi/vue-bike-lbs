...
var bMain = {
    init: function () {
        $.ajax({
            ...
            //},
            data: {
                cityCode:$("#citySelect").attr("areacode")?$("#citySelect").attr("areacode"):"0"
            },
    ...
    initData: function (params) {
        ...
        $.ajax({
            ...
            success: function (data) {
                data.success && data.returnCode == 0 && data.data.data && bMain.parseData(data.data.data);
            }
        });
    },
    ...
    parseNextPageData: function (data) {
        ...
        for (var i = 0; i < pageSize && i < data.datas.length; i++)
            data_append += "<tr><td>" + (data.datas[i].areaName) + "</td><td>" + data.datas[i].cityManager + "</td><td><a href='/tide/ownMission.html?userName="+data.datas[i].userName+"&userId="+data.datas[i].userId+"'>" + data.datas[i].userName + "</a></td><td><a href='/tide/work_list.html?userName="+data.datas[i].userName+"&userId="+data.datas[i].userId+"'>"+ data.datas[i].todayPlanNumber + "</a></td><td>" + data.datas[i].todayDoneNumber + "</td><td>" + data.datas[i].todayDoneRatioStr + "</td><td>" + data.datas[i].currentMonthPlanNumber + "</td><td>" + data.datas[i].currentMonthDoneNumber + "</td><td>" + data.datas[i].currentMonthDoneRatioStr + "</td></tr>";
